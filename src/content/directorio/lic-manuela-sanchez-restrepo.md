...
about: >
  ...
  de planes de alimentación personalizados orientados a la pérdida de grasa,
  recomposición corporal, aumento de masa muscular y mejora de hábitos
  alimentarios.


  Realiza evaluación antropométrica y análisis de composición corporal como base para desarrollar estrategias adaptadas a las necesidades, objetivos y condiciones de cada paciente. Cuenta con experiencia en el abordaje nutricional de dislipidemia, diabetes, resistencia a la insulina e hipertensión arterial, integrando un enfoque preventivo y terapéutico.
